...
jQuery(document).ready(function () {
    ...
    if (jQuery(window).width() > 1024) {
        /* PCs,Desktops etc. */
        jQuery('body').backstretch("https://thememasters.club/html-templates/ombre/images/photos/bg.jpg",{fade:1000});
    }
    else {
        /* Mobile Devices */
        jQuery('body').backstretch("https://thememasters.club/html-templates/ombre/images/photos/bg-small.jpg");
    }
    /* BG IMAGE END */
